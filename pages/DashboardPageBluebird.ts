...
export class BluebirdDashboardPage extends DashboardPage {
  readonly TITLE = "CSRO Dashboard - Bluebird";
  readonly HEADING_RX = /PAX Traveler Status Metrics(?:\s*-\s*Bluebird)?$/i;

  constructor(page: Page) { super(page); }

  async navigateToBluebirdTab(): Promise<void> {
    const tab = this.page.getByRole("tab", { name: "Bluebird", exact: true });
  ...
  async verifyBluebirdTitle(timeout = 10_000) {
